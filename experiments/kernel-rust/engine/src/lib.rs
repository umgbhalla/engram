            ...
            ctx.with(|ctx| {
                ...
                let driver = r#"
                  ...
                  (function(){
                    ...
                    // Expression form: `return (src)` — supports await, returns the value.
                    ...
                    (async function(){
                      try {
                        ...
                        if (fn) {
                          ...
                          // Statement/declaration cell: eval in GLOBAL scope so `let x`,
                          // `function f(){}`, `globalThis.x=` persist. No top-level await here.
